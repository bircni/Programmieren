 ...
 * The classes {@link rl.prog1.util.painttool.PaintTool} is the central element
 * of the framework. Its main method shows a frame with a canvas and a toolbar
 * with two demo buttons added. Class {@link rl.prog1.util.painttool.PaintDemoApp}
 * demonstrates how to extend the functionality by providing
 * a modified version of the controller class
 * ({@link rl.prog1.util.painttool.PaintDemoController})
 * to the constructor of {@link rl.prog1.util.painttool.PaintTool}.
 * 
 ...
 */
package rl.prog1.util.painttool;